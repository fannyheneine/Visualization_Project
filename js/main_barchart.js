...
function createVis_bar() {
    ...
    barchart = new BarChart("bar-chart",data_p, data_i, selection ,500,0.8*500, 15,15,40, "big");
    
    barchart2 = new BarChart("mini-barchart",data_p, data_i, selection ,200, 200, 6, 2,0,"small");
